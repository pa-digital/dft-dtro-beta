...
#RESPONSE=$(curl -s -i -X POST "https://apigee.googleapis.com/v1/organizations/${ORG}/developers/${DEV_EMAIL}/apps/${APP_NAME}/keys/${consumerKey}/apiproducts/${apiproduct}?action=approve" \
#  -H "Authorization: Bearer ${TOKEN}")
#echo "RESPONSE"
#echo "$RESPONSE"
