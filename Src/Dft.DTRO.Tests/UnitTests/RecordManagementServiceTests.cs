...
public class RecordManagementServiceTests
{
    ...
    [Theory]
    [InlineData("3.2.0", "3.2.0-valid", true)]
    [InlineData("3.2.0", "3.2.0-invalid-source-reference", false)]
    [InlineData("3.2.0", "3.2.0-invalid-source-actionType", false)]
    [InlineData("3.2.0", "3.2.0-invalid-provision-reference", false)]
    [InlineData("3.2.0", "3.2.0-invalid-provision-actionType", false)]
    [InlineData("3.2.0", "3.2.0-invalid-duplicate-provision-reference", false)]
    public void ProducesCorrectResults(string schemaVersion, string file, bool isValid)
    {
        ...
        List<SemanticValidationError> actual = sut.ValidateCreationRequest(dtroSubmit);
