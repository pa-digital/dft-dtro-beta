...
public class ApplicationControllerTests : IClassFixture<ApplicationControllerTestFixture>
{
    ...
    public void GetApplicationDetailsValidRequestReturnsOk()
    {
        ...
        ApplicationDetailsDto mockAppDetails = new() { Name = "App1", AppId = appGuid, Purpose = "Test" };
    ...
    public void GetApplicationDetailsNotUsersAppReturnsForbidden()
    {
        ...
        Assert.Empty(forbiddenRequestResult.AuthenticationSchemes);
    }
    ...
    public void GetApplicationsValidUserReturnsOk()
    {
        ...
        {
            new() { Id = Guid.NewGuid(), Name = "App 1", Type = "Test", Tra = "Test" },
            new() { Id = Guid.NewGuid(), Name = "App 2", Type = "Test", Tra = "Test" },
            new() { Id = Guid.NewGuid(), Name = "App 3", Type = "Test", Tra = "Test" }
        };
        _mockApplicationService.Setup(service => service.GetApplicationList(It.IsAny<string>())).Returns(dtos);
