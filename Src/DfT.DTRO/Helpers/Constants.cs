...
public static class Constants
{
    ...
    public static List<string> ProvisionActionTypes => typeof(ProvisionActionType).GetDisplayNames<ProvisionActionType>().ToList();
    ...
    public static IEnumerable<string> RegulationTypes => typeof(RegulationInstanceType).GetDisplayNames<RegulationInstanceType>().ToList();
