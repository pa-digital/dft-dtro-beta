...
namespace DfT.DTRO.Migrations
{
    ...
    [Migration("20250418171320_UpdateErrorReportTable")]
    partial class UpdateErrorReportTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErrorReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ErrorReport", b =>
                {
                    b.HasOne("DfT.DTRO.Models.DataBase.DTRO", "Dtro")
                        .WithMany()
                        .HasForeignKey("TroId")
                        .OnDelete(DeleteBehavior.Restrict);
