public class SecurityHeaders
{
    ...
    {
        context.Response.Headers.Add("Content-Security-Policy", "default-src 'self'; form-action 'self'; object-src 'none'; img-src 'self' data:; script-src 'self' https://cdn.jsdelivr.net");
