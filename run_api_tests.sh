...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    -pi2) PUBLISHER_CLIENT_ID_2="$2"; shift 2;;
    -ps2) PUBLISHER_CLIENT_SECRET_2="$2"; shift 2;;
    -ti2) PUBLISHER_TRA_ID_2="$2"; shift 2;;
    --) shift; break;;
...
PUBLISHER_CLIENT_ID_1="$PUBLISHER_CLIENT_ID_1" \
PUBLISHER_CLIENT_SECRET_1="$PUBLISHER_CLIENT_SECRET_1" \
PUBLISHER_TRA_ID_1="$PUBLISHER_TRA_ID_1" \
PUBLISHER_CLIENT_ID_2="$PUBLISHER_CLIENT_ID_2" \
PUBLISHER_CLIENT_SECRET_2="$PUBLISHER_CLIENT_SECRET_2" \
PUBLISHER_TRA_ID_2="$PUBLISHER_TRA_ID_2" \
